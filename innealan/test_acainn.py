...
class TestLemmatizer(unittest.TestCase):
    ...
    def test_adjectives(self):
        self.assertEqual(self.l.lemmatize("comhair", "Aq-smd"), "comhair")
        self.assertEqual(self.l.lemmatize("làidir", "Aq-smg"), "làidir")
        self.assertEqual(self.l.lemmatize("Mhòir", "Aq-smg"), "mòr")
        self.assertEqual(self.l.lemmatize("t-seann", "Ar"), "seann")

    def test_adverbs(self):
        self.assertEqual(self.l.lemmatize("chaoidh", "Rt"), "chaoidh")
        self.assertEqual(self.l.lemmatize("cho", "Rg"), "cho")
        self.assertEqual(self.l.lemmatize("fhathast", "Rt"), "fhathast")
        self.assertEqual(self.l.lemmatize("sheo", "Rs"), "seo")
        self.assertEqual(self.l.lemmatize("shin", "Rs"), "sin")
        self.assertEqual(self.l.lemmatize("shiud", "Rs"), "siud")
        self.assertEqual(self.l.lemmatize("shuas", "Rs"), "suas")
        self.assertEqual(self.l.lemmatize("thall", "Rs"), "thall")
        self.assertEqual(self.l.lemmatize("thairis", "Rg"), "thairis")
        self.assertEqual(self.l.lemmatize("thairis", "Rs"), "thairis")
        self.assertEqual(self.l.lemmatize("thric", "Rt"), "tric")
    ...
    def test_interjections(self):
        self.assertEqual(self.l.lemmatize("bhuel", "I"), "bhuel")
        self.assertEqual(self.l.lemmatize("shìorraidh", "I"), "sìorraidh")
        self.assertEqual(self.l.lemmatize("uh", "I"), "uh")

    def test_nouns(self):
        self.assertEqual(self.l.lemmatize("a'", "Nn"), "an")
        self.assertEqual(self.l.lemmatize("aibhne", "Ncsfg"), "abhainn")
        self.assertEqual(self.l.lemmatize("Aonghais", "Nn-mv"), "Aonghas")
        self.assertEqual(self.l.lemmatize("athar", "Ncsmg"), "athair")
        self.assertEqual(self.l.lemmatize("bainnse", "Ncsfg"), "banais")
        self.assertEqual(self.l.lemmatize("bàird", "Ncpmd"), "bàrd")
        self.assertEqual(self.l.lemmatize("bhalaich", "Ncsmv"), "balach")
        self.assertEqual(self.l.lemmatize("bàt’", "Ncsmn"), "bàta")
        self.assertEqual(self.l.lemmatize("bhàgh", "Ncsmd"), "bàgh")
        self.assertEqual(self.l.lemmatize("bheachd", "Ncsmd"), "beachd")
        ...
        self.assertEqual(self.l.lemmatize("cheanglaichean", "Ncpmg"), "ceangal")
        ...
        self.assertEqual(self.l.lemmatize("chrìch", "Ncsfd"), "crìoch")
        self.assertEqual(self.l.lemmatize("chrìche", "Ncsfg"), "crìoch")
        self.assertEqual(self.l.lemmatize("Christie", "Nn"), "Christie")
        self.assertEqual(self.l.lemmatize("chìche", "Ncsfg"), "cìoch")
        self.assertEqual(self.l.lemmatize("cuimhne", "Ncsfd"), "cuimhne")
        self.assertEqual(self.l.lemmatize("doruis", "Ncsmg"), "dorus")
        self.assertEqual(self.l.lemmatize("dusan", "Ncsmd"), "dusan")
        self.assertEqual(self.l.lemmatize("dùthaich", "Ncsfd"), "dùthaich")
        self.assertEqual(self.l.lemmatize("dùthcha", "Ncsfg"), "dùthaich")
        self.assertEqual(self.l.lemmatize("èisg", "Ncsmg"), "iasg")
        self.assertEqual(self.l.lemmatize("feòir", "Ncsmg"), "feur")
        ...
        self.assertEqual(self.l.lemmatize("Iain", "Nn-mg"), "Iain")
        self.assertEqual(self.l.lemmatize("'ill'", "Ncsmv"), "gille")
        self.assertEqual(self.l.lemmatize("'ille", "Ncsmv"), "gille")
        self.assertEqual(self.l.lemmatize("ìre", "Ncsfd"), "ìre")
        self.assertEqual(self.l.lemmatize("Keir", "Nn-md"), "Keir")
        self.assertEqual(self.l.lemmatize("laoigh","Ncpmn"), "laogh")
        self.assertEqual(self.l.lemmatize("Magaidh", "Nn-fd"), "Magaidh")
        self.assertEqual(self.l.lemmatize('mhargaidh', "Ncsmd"), 'margadh')
        ...
        self.assertEqual(self.l.lemmatize("MhicAoidh", "Nn"), "MacAoidh")
        ...
        self.assertEqual(self.l.lemmatize("dh’oidhcheannan", "Ncpfd"),
                         "oidhche")
        self.assertEqual(self.l.lemmatize("Oisein", "Nn-mg"), "Oisean")
        self.assertEqual(self.l.lemmatize("peantairean", "Ncpmn"), "peantair")
        self.assertEqual(self.l.lemmatize("phlèanaichean", "Ncpmg"), "plèana")
        self.assertEqual(self.l.lemmatize("pìosan", "Ncpmd"), "pìos")
        ...
        self.assertEqual(self.l.lemmatize("Sheòrais", "Nn-mg"), "Seòras")
        self.assertEqual(self.l.lemmatize("seòrsachan","Ncpfn"), "seòrsa")
        self.assertEqual(self.l.lemmatize("sgìre", "Ncsfg"), "sgìre")
        self.assertEqual(self.l.lemmatize("sheòid", "Ncsmv"), "seud")
        self.assertEqual(self.l.lemmatize("slighe", "Ncsfd"), "slighe")
        self.assertEqual(self.l.lemmatize("Stàitchiste", "Ncsfg"),
                         "stàitchiste")
        self.assertEqual(self.l.lemmatize("taighe", "Ncsmg"), "taigh")
        self.assertEqual(self.l.lemmatize("tairbh", "Ncpmn"), "tarbh")
        self.assertEqual(self.l.lemmatize("tairgse", "Ncsfd"), "tairgse")
        self.assertEqual(self.l.lemmatize("teantaichean", "Ncpmd"), "teanta")
        self.assertEqual(self.l.lemmatize("t-samhradh", "Ncsmd"), "samhradh")
        self.assertEqual(self.l.lemmatize("t-sead", "Ncsmd"), "sead")
        self.assertEqual(self.l.lemmatize("t-sìde", "Ncsfd"), "sìde")
        self.assertEqual(self.l.lemmatize("t-sluagh", "Ncsmd"), "sluagh")
        self.assertEqual(self.l.lemmatize("t-suidheachaidh", "Ncsmg"),
                         "suidheachadh")
        self.assertEqual(self.l.lemmatize("Theàrlaich", "Nn-mg"), "Teàrlach")
        self.assertEqual(self.l.lemmatize("uamha", "Ncsfd"), "uamh")
        self.assertEqual(self.l.lemmatize("Uilleim", "Nn-mg"), "Uilleam")
        self.assertEqual(self.l.lemmatize("ùine", "Ncsfd"), "ùine")
        self.assertEqual(self.l.lemmatize("uinneig", "Ncsfd"), "uinneag")

        self.assertEqual(self.l.lemmatize("bhliadhnachan", "Ncpfg"), "bliadhna")
        self.assertEqual(self.l.lemmatize("beothaichean", "Ncpmg"), "beothach")
        self.assertEqual(self.l.lemmatize("h-ailt", "Ncpmd"), "alt")
        self.assertEqual(self.l.lemmatize("àiteachan","Ncpfn"), "àite")
        self.assertEqual(self.l.lemmatize("h-Innseachan","Nt"), "Innseachan")
        self.assertEqual(self.l.lemmatize("ghineachan","Ncpmg"), "gine")
    ...
    def test_irregulars(self):
        ...
        self.assertEqual(self.l.lemmatize("deachaidh", "V-s--d"), "rach")
    ...
    def preposition(self, preposition, root):
        self.assertEqual(self.l.lemmatize(preposition, "Sp"), root)

    def test_prepositions(self):
        self.preposition("a'd", 'aig')
        self.preposition("a'm", 'aig')
        self.preposition('anns','an')
        self.preposition('am','an')
        self.preposition('anns an','an')
        self.preposition('agad','aig')
        self.preposition('agad-sa','aig')
        self.preposition('agam','aig')
        self.preposition('airson','airson')
        self.preposition('aiste','as')
        self.preposition('annamsa','an')
        self.preposition('asam','as')
        self.preposition('chun', 'gu')
        self.preposition('dhà-san', 'do')
        self.preposition('dham', 'do')
        ...
        self.preposition('riutha','ri')
        self.preposition('ruinn','ri')
        self.preposition('ruibh','ri')
        self.preposition('ron','ro')
        self.preposition("‘sa", 'an')
        self.preposition('tharad','thar')
        self.preposition('thairis','thar')
        self.preposition('thuice', 'gu')
        self.preposition('thuige','gu')
        self.preposition('uam','bho')

    def test_pronouns(self):
        self.assertEqual(self.l.lemmatize("chéile", "Px"), "céile")
        self.assertEqual(self.l.lemmatize("chèile", "Px"), "cèile")
        self.assertEqual(self.l.lemmatize("fhéin", "Px"), "féin")
        self.assertEqual(self.l.lemmatize("fhèin", "Px"), "fèin")
        self.assertEqual(self.l.lemmatize("fhìn", "Px"), "fèin")
    ...
    def test_regulars(self):
        ...
        self.assertEqual(self.l.lemmatize("thadhladh", "V-h"), "tadhail")
